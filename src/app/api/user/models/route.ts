 ...
 *
 * Returns models enabled by user in profile, for project config dropdown.
 * Capabilities come only from system built-in catalog (do not trust user-submitted model.capabilities).
 */
